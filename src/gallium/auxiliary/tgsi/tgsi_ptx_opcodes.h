...
OPCODE(1, 1, COMP, FRC, 1, .rz.f32.f32, 0)
OPCODE(1, 2, OTHR, TXF_LZ, 0, "", /*.is_tex =*/ 1)
OPCODE(1, 1, COMP, FLR, 1, .rz.f32.f32, 0)
...
OPCODE(1, 1, COMP, I2F, 1, .f32.s32, 0)
...
OPCODE(1, 2, COMP, FSLT, 1, .s32.f32, 0)
